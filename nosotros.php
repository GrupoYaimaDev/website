...
<head>
    ...
    <meta property="og:title" content="GRUPO YAIMA | Nosotros"/>
    <meta property="og:site_name" content="Grupo Yaima | Comercializadora de Insumos y Agro-insumos"/>
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://www.grupoyaima.com/nosotros" />
    ...
    <meta name="keywords" content="nosotros grupoyaima,nosotros Grupo Yaima,nosotros Yaima,nosotros ABA,nosotros Comercializadora de Insumos,nosotros Agroinsumos, Materia Prima,nosotros Granos,nosotros Portuguesa,nosotros Venezuela Grupo Yaima, Harina,nosotros Consumo Animal,nosotros Aportando al Futuro, Somos yaima, Sitio web Yaima">
...
<body class="bg-black" style="background: linear-gradient(357deg, #040404, #313131);">
    ...
    <section class="w-full bg-white py-4 cut-top overflow-hidden">
        <article class="wow fadeIn max-w-5xl rounded-md mx-auto w-full p-8">
            ...
            <p class="text-justify_center ">
                Somos especialistas de la comercializaci&oacute;n y distribuci&oacute;n de materias primas de alta calidad nutricional, para la producci&oacute;n de productos agro-alimentarios(ABA). somos comercializadora de insumos y agro-insumos con capacidad de respuesta a la alta demanda del mercado.
            </p>
        </article>
    </section>
    <section class="overflow-hidden bg-lightwhite py-12 inner-block" style="background-image: url(./src/pattern.png)">
        <article class="grid max-w-5xl text-white rounded-xl overflow-hidden tracking-wide mx-auto my-8">
            <div class="bg-blue grid md:grid-cols-2">
                ...
                <div class="flex flex-col gap-4 justify-center items-center p-8">
                    ...
                    <b class="popBold">GRUPO YAIMA </b>  es una empresa integra, honesta y responsable dedicada a la distribuci&oacute;n y comercializaci&oacute;n de materias primas, insumos y agro-insumos diferenciados por la alta calidad y eficiencia que nos caracteriza manteniendo así nuestro apoyo constante al productor nacional.
                    </p>
                </div>
            </div>
            <div class="bg-green grid md:grid-cols-2">
                <img src="./src/vision.jpg" class="md:order-1 h-400p object-cover w-full" alt="">
                <div class="flex flex-col gap-4 justify-center items-center p-8">
                    ...
                    <p class="text-sm text-justify_center">
                    <b class="popBold">GRUPO YAIMA</b> proyecta un crecimiento rentable y sostenible para mejorar y expandir nuestra gama de productos y servicios queriendo posicionarse entre los mejores comercializadores y distribuidores de materias primas, insumos y agro-insumos de la más alta calidad comprometidos con el avance y mejora continua en el proceso de industrializaci&oacute;n
                    </p>
                </div>
            </div>
        </article>
    ...
    <section class="borde-y-white bg-white w-full py-8 overflow-hidden">
        <article class="wow animated fadeInLeft max-w-3xl rounded-md mx-auto w-full p-4 xl:p-8">
            ...
            <p class="text-justify_center p-4">
                Si deseas obtener informaci&oacute;n acerca de promociones y eventos únete a nuestra comunidad en redes.
            </p>
        </article>
